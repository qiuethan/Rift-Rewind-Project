...
/**
 * Get champion key from champion ID
 * @param championId - The champion ID from Riot API
 ...
 */
export const getChampionSplashUrl = (championKey: string, skinNum: number = 0): string => {
